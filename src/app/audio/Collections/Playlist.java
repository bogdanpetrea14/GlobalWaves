...
public final class Playlist extends AudioCollection {
    ...
    public boolean equals(final Object obj) {
        ...
        return this.getName().equals(playlist.getName())
                && this.getOwner().equals(playlist.getOwner())
                && this.getTimestamp() == playlist.getTimestamp()
                && this.getVisibility().equals(playlist.getVisibility())
                && this.getFollowers().equals(playlist.getFollowers())
                && this.getSongs().equals(playlist.getSongs());
    }
}
