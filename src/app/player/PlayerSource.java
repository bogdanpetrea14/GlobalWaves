...
public class PlayerSource {
    ...
    public PlayerSource(final PlayerSource source) {
        this.type = source.getType();
        this.audioCollection = source.getAudioCollection();
        this.audioFile = source.getAudioFile();
        this.index = source.getIndex();
        this.indexShuffled = source.getIndexShuffled();
        this.remainedDuration = source.getRemainedDuration();
    }
